...
- [x] Season/episode extraction correct for 95%+ of test patterns
- [x] Resolution detection accurate for all standard formats
- [x] Content type classification correct for 90%+ of test data
- [x] International titles handled appropriately
- [x] All unit tests pass
- [x] Classification of 10k titles completes in <5 seconds
- [x] Edge cases documented and handled

## Completion Notes

- Full classifier implementation in `/internal/classifier/classifier.go`
- Comprehensive test suite with 50+ test cases in `classifier_test.go`
- Season/episode extraction supports multiple formats: S01E05, 1x05, Season 1 Episode 5
- International pattern support: French (Saison), Spanish (Temporada), German (Staffel)
- Resolution detection: 4K, 1080p, 720p, 480p with keyword variants
- Content type classification with confidence scoring (0-100)
- Edge case handling: empty strings, malformed patterns, multiple years
